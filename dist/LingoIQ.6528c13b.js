...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (switchToSignup && signupPopup && signinPopup) switchToSignup.addEventListener('click', (e)=>{
        e.preventDefault();
    ...
    const handleGoogleLogin = async (e)=>{
        e.preventDefault();
        e.stopPropagation();
        await (0, _authJs.loginWithGoogle)();
    };
...
},{"buffer":"bCaf4","./i18n":"lQCzu","./auth.js":"aTIl8"}],"lQCzu":[function(require,module,exports,__globalThis) {
// src/js/i18n.js
